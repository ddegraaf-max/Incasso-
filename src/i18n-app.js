...
const pl = {
  ...
  wykup: {
    ...
    sold: 'Sprzedana · wypłata do 24 h', accept: 'Przyjmij', decline: 'Odrzuć',
    declined: 'Oferta odrzucona · windykacja trwa', acceptAnyway: 'Jednak przyjmij',
  ...
  admin: {
    ...
    on: 'Włączone', off: 'Brak', casesKicker: 'Sprawy — status akcji', stCollect: 'Windykacja', stSold: 'Sprzedana', stClosed: 'Zamknięta', stDeclined: 'Oferta odrzucona',
...
const en = {
  ...
  wykup: {
    ...
    declined: 'Offer declined · collection continues', acceptAnyway: 'Accept after all',
  ...
  admin: {
    ...
    on: 'Enabled', off: 'None', casesKicker: 'Cases — action status', stCollect: 'Collection', stSold: 'Sold', stClosed: 'Closed', stDeclined: 'Offer declined',
